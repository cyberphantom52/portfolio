...
const BlogCard: React.FC<Props> = async (props) => {
  ...
  return (
    <Link href={`/blogs/${props.metadata.id}`} className={`${props.cardClass} rounded-2xl flex flex-col p-6 overflow-hidden hover:scale-105 transition-transform duration-75 ease-out`}>
